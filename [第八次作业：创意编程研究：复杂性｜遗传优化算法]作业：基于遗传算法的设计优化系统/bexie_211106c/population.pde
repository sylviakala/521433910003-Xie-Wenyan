class Population {
  ...
  Population(float m, int num) {
    ...
    for (int i = 0; i < population.length; i++) {
      population[i] = new Design(new DNA(), 350+(i%(population.length/2))*220, 100 + ceil(i/(population.length/2))*240);
    }
  }
  ...
  void reproduction() {
    ...
    for (int i = 0; i < population.length; i++) {
      ...
      population[i] = new Design(child,350+(i%(population.length/2))*220, 100 + ceil(i/(population.length/2))*240);
    }
    generations++;
  }
